...
class Solution(object):
    def getIntersectionNode(self, headA, headB):
        ...
        for i in range(0,count):
            if listA[lenA-i-1]!=listB[lenB-i-1]:
                return listA[lenA-i]
        return listA[lenA-count]
```
